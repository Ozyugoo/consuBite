        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:space-x-16">
          <div className="w-full lg:w-1/2 mb-8 lg:mb-8">
            <img
              ...
              alt="whatWeServeImage"
              className="w-full h-auto"
            />
          </div>
          <div className="m-20 w-full">
            <h1 className="text-xl md:text-4xl font-bold mb-6">
              What We <span className="text-custom-red">Serve</span>
            </h1>
            <p className="text-xs sm:text-base font-normal mb-4">
              Lorem ipsum dolor sit amet consectetur. Sem at nullam aliquam quam
              rhoncus amet at lobortis nec. Morbi ut tincidunt eu tempus amet at
              sit. Bibendum tortor vitae convallis diam pellentesque eu est
              mattis. Vestibulum sit habitant non vitae.
            </p>
