...
function Details() {
  ...
  return (
    <div
      className={`w-1/2 mx-auto relative py-6 ${isOpen ? "" : "hidden"}`}
    >
      <img
        src={Close}
        onClick={closeMenu}
        className="py-5 pr-5 cursor-pointer absolute right-4"
      />
      ...
      <div className="md:flex space-x-6 justify-center my-4">
        <Button
          variant="secondary"
          className="md:flex justify-between items-center py-4 md:py-0"
        >
