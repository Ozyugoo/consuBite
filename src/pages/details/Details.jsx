...
function Details() {
  ...
  function togglePayment() {
    ...
    navigate("/checkout", cart); // No need to pass the cart state if it's available in context
  }
    ...
    <div className="text-base">
      {meal && (
        <Modal isOpen={true}>
          ...
          <div className="flex flex-wrap justify-between items-center font-bold my-6 mx-24 md:mx-0">
            <Button
              variant="secondary"
              className="flex justify-center items-center text-sm w-full md:w-1/2 "
